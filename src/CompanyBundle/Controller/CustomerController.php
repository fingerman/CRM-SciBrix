...
use CompanyBundle\Entity\Customer;
...
class CustomerController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $customers = $em->getRepository('CompanyBundle:Customer')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('CompanyBundle\Form\CustomerType', $customer);
    ...
    {
        $deleteForm = $this->createDeleteForm($customer);
        $editForm = $this->createForm('CompanyBundle\Form\CustomerType', $customer);
