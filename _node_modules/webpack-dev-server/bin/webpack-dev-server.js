...
yargs.options({
  ...
  'history-api-fallback': {
    type: 'boolean',
    describe: 'Fallback to /index.html.php for Single Page Applications.',
    group: RESPONSE_GROUP
  },
  compress: {
    type: 'boolean',
...
function reportReadiness(uri, options) {
  ...
  if (!options.quiet) {
    ...
    if (options.historyApiFallback) { console.log(`404s will fallback to ${colorInfo(useColor, options.historyApiFallback.index || '/index.html.php')}`); }
